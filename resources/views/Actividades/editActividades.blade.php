                ...
                <form action="{{ route('actividades.update', $actividades->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="descripcion" class="form-control"
                            value="{{ old('descripcion', $actividades->descripcion) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="codigo_osticket" class="form-control"
                            value="{{ old('codigo_osticket', $actividades->codigo_osticket) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_inicio" class="form-control"
                            value="{{ old('fecha_inicio', $actividades->fecha_inicio->format('Y-m-d')) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="avance" class="form-control"
                            value="{{ old('avance', $actividades->avance) }}" min="0" max="100" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="estado" class="form-control" required>
                            <option value="EN CURSO"
                                {{ old('estado', $actividades->estado) == 'EN CURSO' ? 'selected' : '' }}>En Curso</option>
                            <option value="FINALIZADO"
                                {{ old('estado', $actividades->estado) == 'FINALIZADO' ? 'selected' : '' }}>Finalizado
                            </option>
                            <option value="PENDIENTE"
                                {{ old('estado', $actividades->estado) == 'PENDIENTE' ? 'selected' : '' }}>Pendiente
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="tiempo" class="form-control"
                            value="{{ old('tiempo', $actividades->tiempo) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_fin" class="form-control"
                            value="{{ old('fecha_fin', $actividades->fecha_fin->format('Y-m-d')) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="repetitivo" class="form-control" required>
                            <option value="1" {{ old('repetitivo', $actividades->repetitivo) ? 'selected' : '' }}>Sí
                            </option>
                            <option value="0" {{ old('repetitivo', $actividades->repetitivo) ? '' : 'selected' }}>No
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="prioridad" class="form-control" required>
                            <option value="ALTA"
                                {{ old('prioridad', $actividades->prioridad) == 'ALTA' ? 'selected' : '' }}>Alta</option>
                            <option value="MEDIA"
                                {{ old('prioridad', $actividades->prioridad) == 'MEDIA' ? 'selected' : '' }}>Media</option>
                            <option value="BAJA"
                                {{ old('prioridad', $actividades->prioridad) == 'BAJA' ? 'selected' : '' }}>Baja</option>
                        </select>
                    </div>
                        ...
                        <select name="departamento_id" class="form-control" required>
                            @foreach ($departamentos as $departamento)
                                <option value="{{ $departamento->id }}"
                                    {{ old('departamento_id', $actividades->departamento_id) == $departamento->id ? 'selected' : '' }}>
                                    {{ $departamento->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="error" class="form-control" required>
                            <option value="CLIENTE" {{ old('error', $actividades->error) == 'CLIENTE' ? 'selected' : '' }}>
                                Cliente</option>
                            <option value="SOFTWARE"
                                {{ old('error', $actividades->error) == 'SOFTWARE' ? 'selected' : '' }}>Software</option>
                            <option value="MEJORA ERROR"
                                {{ old('error', $actividades->error) == 'MEJORA ERROR' ? 'selected' : '' }}>Mejora Error
                            </option>
                            <option value="DESARROLLO"
                                {{ old('error', $actividades->error) == 'DESARROLLO' ? 'selected' : '' }}>Desarrollo
                            </option>
                        </select>
                    </div>
