                    ...
                    <tr>
                        ...
                        <td>
                            @if ($empleados->curriculum)
                                <a href="{{ asset('storage/' . $empleados->curriculum) }}" class="btn btn-info btn-sm"
                        ...
                        <td>
                            @if ($empleados->contrato)
                                <a href="{{ asset('storage/' . $empleados->contrato) }}" class="btn btn-info btn-sm"
                        ...
                        <td>
                            @if ($empleados->contrato_confidencialidad)
                                <a href="{{ asset('storage/' . $empleados->contrato_confidencialidad) }}"
                        ...
                        <td>
                            @if ($empleados->contrato_consentimiento)
                                <a href="{{ asset('storage/' . $empleados->contrato_consentimiento) }}"
                        ...
                        <td>
                            ...
                            <form action="{{ route('empleados.destroy', $empleados) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
